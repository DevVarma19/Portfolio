        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                ...
                <li class="nav-item theme-text">
                    <a href="{{ route('home') }}" class="nav-link"> VARMA </a>
                </li>
            </ul>
            ...
            <ul class="navbar-item flex-row ml-md-auto">
                ...
                <li class="nav-item dropdown user-profile-dropdown">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                        <img src="admin\assets\img\varma.jpg" alt="avatar">
                    </a>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span id="title"></span></li>
                            </ol>
                        </nav>
    ...
    <div class="main-container" id="container">
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu">
                        <a href="{{ route('admin.dashboard') }}" data-active="{{ (request()->is('dashboard')) ? 'true' : 'false' }}"  class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{ route('admin.services') }}" data-active="{{ (request()->is('services')) ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{ route('admin.testimonial') }}" data-active="{{ (request()->is('testimonial')) ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{ route('admin.education') }}" data-active="{{ (request()->is('education')) ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{ route('admin.work') }}" data-active="{{ (request()->is('work')) ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{ route('admin.skills') }}" data-active="{{ (request()->is('skills')) ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{ route('admin.portfolio') }}" data-active="{{ (request()->is('portfolio')) ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{ route('admin.contact') }}" data-active="{{ (request()->is('contact')) ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{ route('admin.settings') }}" data-active="{{ (request()->is('settings')) ? 'true' : 'false' }}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
        ...
        <div class="footer-wrapper">
            <div class="footer-section f-section-1">
                <p class="">Copyright © 2020 <a target="_blank" href="/">Varma</a>, All rights reserved.</p>
            </div>
